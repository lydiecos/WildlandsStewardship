...
\hypersetup{
  pdftitle={Stewardship for Double H},
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0442}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.6637}}
...
\midrule()
\endhead
2022 & Failed Structure & & Left bank behind Boulder toe has collapsed.
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0294}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1235}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1235}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.3118}}
...
\midrule()
\endhead
2022 & Japanese Barberry & Oriental Bittersweet & & & & & No \\
