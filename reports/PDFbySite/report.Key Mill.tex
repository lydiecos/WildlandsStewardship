...
\hypersetup{
  pdftitle={Stewardship for Key Mill},
  pdfauthor={Lead Steward: Dominic},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Stewardship for Key Mill}
...
\midrule()
\endhead
2022 & Bare Areas \& Low Stem Vigor/Height \\
\bottomrule()
\end{longtable}
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.0472}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.3396}}
...
2022 & Tree Of Heaven & & & & & \\
2021 & Chinaberry & & & & & \\
2021 & Chinese Privet & Mimosa & & & & \\
2021 & OTHER & & Cattails & & & \\
2021 & OTHER & & Cattails & Cattail treatment with Alligaire 3L & & \\
2021 & Tree Of Heaven & Chinese Privet & & & & \\
2021 & Tree Of Heaven & & & Tree Treatment & Hack and Squirt &
10/2021 \\
\bottomrule()
\end{longtable}
