...
\hypersetup{
  pdftitle={Stewardship for Falling Creek},
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0248}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1287}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0891}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.4406}}
...
\midrule()
\endhead
2022 & Channel Stability/Erosion & Slumping\_Settling & Drainage from
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.0424}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.3814}}
